...
//     }
//
//     String area = journeyData['translated_area']?[currentLanguage] ?? 'No Info';
//     String spotName = journeyData['translated_title']?[currentLanguage] ?? 'No Info';
//     String shortDescription = journeyData['translated_description']?[currentLanguage] ?? 'No Info';
//
//     return Padding(
//     padding: const EdgeInsets.symmetric(horizontal: 24.0),
//     child: Container(
...
//     var spotId = spotData['spot_id'];
//
//     // Check if the spot is already added
//     if (selectedSpots.any((spot) => spot['spotName'] == spotData['translated_name'][currentLanguage])) {
//     setState(() {
//     selectedSpots.removeWhere((spot) => spot['spotName'] == spotData['translated_name'][currentLanguage]);
//     selectedLocations.removeWhere((location) => location['spotName'] == spotData['translated_name'][currentLanguage]);
//     });
//     } else {
//     // Fetch spot details and images if not already added
//     DocumentSnapshot spotSnapshot = await _fetchSpotData(spotId);
//     var spotDetails = spotSnapshot.data() as Map<String, dynamic>;
//     List<String> images = spotImages[spotId                         ] ?? [];        setState(() {
//       selectedSpots.add({
//         'spotName': spotDetails['translated_name'][currentLanguage] ?? "No name",
//         'imageUrl': images.isNotEmpty
//             ? images[0]
//             : '',
//       });
//       selectedLocations.add({
//         'spotName': spotDetails['translated_name'][currentLanguage] ?? "No name",
//         'location': spotDetails['location'], // Assuming location is stored in the spotData
//       });
//     });
//     }
//     }
...
//                                     Navigator.push(context,
//                                       MaterialPageRoute(
//                                         builder: (context) => SpotDetail(spotItem: spotData),
//                                       ),
//                                     );
//                                   } else {
