...
class _CardListPlanState extends State<CardListPlan> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: _fetchJourneyData(widget.journeyId),
      builder: (context, snapshot) {
        ...
        Map<String, dynamic> journeyData = snapshot.data!;
                      ...
                      children: [
                        ...
                        if (isExpanded)
                          FutureBuilder<List<DocumentSnapshot>>(
                            future: _fetchJourneySpots(widget.journeyId),
                            builder: (context, snapshot) {
                              if (snapshot.connectionState ==
                                ...
                                return Center(
                                    child: Text('Error fetching Journey spots'));
                              } else if (!snapshot.hasData || snapshot.data!
                                  .isEmpty) {
                                return Center(
                                    child: Text('No journey spots found'));
                              } else {
